...
IF Col_Length('VsCH_PatientInfo','CH0ATY02') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY02] [int] NULL --清洁手术前0.5-2小时内给药
IF Col_Length('VsCH_PatientInfo','CH0ATY03') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY03] [int] NULL --联合用药
IF Col_Length('VsCH_PatientInfo','CH0ATY04') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY04] [int] NULL --髋关节置换术前0.5-2小时内给药
IF Col_Length('VsCH_PatientInfo','CH0ATY05') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY05] [int] NULL --膝关节置换术前0.5-2小时内给药
IF Col_Length('VsCH_PatientInfo','CH0ATY06') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY06] [int] NULL --子宫肌瘤切除术前0.5-2小时内给药
IF Col_Length('VsCH_PatientInfo','CH0ATY07') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY07] [int] NULL --手术相关医院感染
IF Col_Length('VsCH_PatientInfo','CH0ATY08') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY08] [int] NULL --血液透析
IF Col_Length('VsCH_PatientInfo','CH0ATY09') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY09] [int] NULL --与血液透析相关感染
IF Col_Length('VsCH_PatientInfo','CH0ATY10') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY10] [int] NULL --单病种质量管理与费用控制病种
IF Col_Length('VsCH_PatientInfo','CH0ATY11') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY11] [int] NULL --纳入质控
IF Col_Length('VsCH_PatientInfo','CH0ATY12') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY12] [varchar](50) NULL --未纳入原因
IF Col_Length('VsCH_PatientInfo','CH0ATY13') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY13] [int] NULL --是否发生围术期死亡
IF Col_Length('VsCH_PatientInfo','CH0ATY14') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY14] [int] NULL --是否发生术后猝死
IF Col_Length('VsCH_PatientInfo','CH0ATY15') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY15] [int] NULL --输血反应
IF Col_Length('VsCH_PatientInfo','CH0ATY16') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY16] [int] NULL --输液反应 
IF Col_Length('VsCH_PatientInfo','CH0ATY17') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY17] [int] NULL --肺部感染
IF Col_Length('VsCH_PatientInfo','CH0ATY18') Is Null  Alter Table VsCH_PatientInfo Add [CH0ATY18] [int] NULL --距上一次住本院时间 
